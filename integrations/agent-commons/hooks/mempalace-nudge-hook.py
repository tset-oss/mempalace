...
NUDGE_REASON = (
    ...
    "durable fact to the right tool and shape per the tset:mempalace skill (the "
    ...
    "(<model-id>)' on drawers (e.g. 'markus.burger@tset.com "
    "(claude-sonnet-4-6)'), and checkpoint with mempalace_diary_write "
    "(agent_name=<operator handle>, e.g. 'markus.burger', topic=<tag>) — an "
